local Translations = {
    ...
    text = {
		enter_car_warehouse = "Enter Car Warehouse",
        exit_car_warehouse = "Exit Car Warehouse",
        		
		point_exit_car_warehouse = "Exit Car Warehouse",
        point_enter_car_warehouse = "Enter Car Warehouse",	
